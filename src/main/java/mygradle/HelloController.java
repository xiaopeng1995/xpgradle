...
public class HelloController {
    @RequestMapping(value = "/XQCenters/ervlet/GetSBP", method = RequestMethod.GET)
    public String test(HttpServletRequest request, HttpServletResponse response) {
        ...
        String json = "{\"ss\":[{\"new\":1,\"s_id\":220002,\"name\":\"2服-楚汉争9\",\"column\":1,\"id\":\"220002\",\"state\":2,\"url\":\"120.92.138.58:10096\",\"desc\":\"欢迎来到寻秦！\"}]}";
        return json;
    }
